...
import { AcceptClinicInvitationInput, ClinicInvitation } from '../../../domain/clinic/types/clinic.types';
  ...
  implements IAcceptClinicInvitationUseCase
{
  ...
  protected async handle(
    ...
    const clinic = await this.clinicRepository.findByTenant(invitation.tenantId, invitation.clinicId);
    if (!clinic) {
